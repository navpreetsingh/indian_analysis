...
class BseBestStrategy < ActiveRecord::Base
	...
	def self.csv_op
		...
		datab_b = [["Name", "Last_close", "Expected Profit %", "Target 1", "Stop Loss 1", "Target 2", "Stop Loss 2", "Target 3", "Stop Loss 3", "Expected Open", "Expected High", "Expected Low", "Expected Close", "Strategy", "Predicted Signal"]]
		datab_b_all.each do |d|
			datab_b << [d.stock_name, d.last_close, d.profit_percent, d.target_1, d.stop_loss_1, d.target_2, d.stop_loss_2, d.target_3, d.stop_loss_3, d.open, d.high, d.low, d.close, d.strategy, d.predicted_signal]
		end

		datab_s_all = BseBestStrategy.where("bs_signal = -1").order("profit_percent desc").limit(10)
		datab_s = [["Name", "Last_close", "Expected Profit %", "Target 1", "Stop Loss 1", "Target 2", "Stop Loss 2", "Target 3", "Stop Loss 3", "Expected Open", "Expected High", "Expected Low", "Expected Close", "Strategy", "Predicted Signal"]]
		datab_s_all.each do |d|
			datab_s << [d.stock_name, d.last_close, d.profit_percent, d.target_1, d.stop_loss_1, d.target_2, d.stop_loss_2, d.target_3, d.stop_loss_3, d.open, d.high, d.low, d.close, d.strategy, d.predicted_signal]
		end

		datan_b_all = NseBestStrategy.where("bs_signal = 1").order("profit_percent desc").limit(10)
		datan_b = [["Name", "Last_close", "Expected Profit %", "Target 1", "Stop Loss 1", "Target 2", "Stop Loss 2", "Target 3", "Stop Loss 3", "Expected Open", "Expected High", "Expected Low", "Expected Close", "Strategy", "Predicted Signal"]]
		datan_b_all.each do |d|
			datan_b << [d.stock_name, d.last_close, d.profit_percent, d.target_1, d.stop_loss_1, d.target_2, d.stop_loss_2, d.target_3, d.stop_loss_3, d.open, d.high, d.low, d.close, d.strategy, d.predicted_signal]
		end

		datan_s_all = NseBestStrategy.where("bs_signal = -1").order("profit_percent desc").limit(10)
		datan_s = [["Name", "Last_close", "Expected Profit %", "Target 1", "Stop Loss 1", "Target 2", "Stop Loss 2", "Target 3", "Stop Loss 3", "Expected Open", "Expected High", "Expected Low", "Expected Close", "Strategy", "Predicted Signal"]]
		datan_s_all.each do |d|
			datan_s << [d.stock_name, d.last_close, d.profit_percent, d.target_1, d.stop_loss_1, d.target_2, d.stop_loss_2, d.target_3, d.stop_loss_3, d.open, d.high, d.low, d.close, d.strategy, d.predicted_signal]
		end
