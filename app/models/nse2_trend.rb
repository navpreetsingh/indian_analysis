class Nse2Trend < ActiveRecord::Base
	...
	def self.trend2
		...
		Nse2Trend.destroy_all
		ids = NseStock.where(:vol_category => 2).collect(&:id)
		ids.each do |stock|
		#stock = ids[0]
			...
			Nse2Trend.create(:nse_stock_id => stock, :d30_t => data_ti[0], :d_30_hi => data_hi[0],
